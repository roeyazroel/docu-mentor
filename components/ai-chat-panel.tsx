    ...
    <>
      <div className="flex-1 flex flex-col overflow-hidden">
        <div ref={scrollRef} className="flex-1 overflow-y-auto p-4" style={{ maxHeight: "calc(100vh - 200px)" }}>
          {apiKeyError && (
            <div className="mb-4 p-2 bg-yellow-50 rounded-md text-xs text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-200">
              <p>Demo Mode: Using simulated AI responses</p>
            </div>
          )}
